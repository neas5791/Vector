...
public class CopyOfVector {
	...
	public CopyOfVector (double x, double y, double z){
		this.x = x;
		this.y = y;
		this.z = z;
	}
...
//	}
	 ...
	 * @return the vector resultant
	 */
	public static CopyOfVector add(CopyOfVector v1, CopyOfVector v2){
		return new CopyOfVector(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z);
	}
...
//	}
	 ...
	 * @return the resultant vector
	 */
	public static CopyOfVector minus(CopyOfVector v1, CopyOfVector v2){
		return new CopyOfVector(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z);
	}
	 ...
	 */
	public static CopyOfVector scalarMultiplication(double scalar, CopyOfVector v){
		return new CopyOfVector(scalar * v.x, scalar * v.y, scalar * v.z);
	}
...
//	}
	 ...
	 * @return the dot product of two vectors
	 */	
	public static double dotProduct(CopyOfVector v1, CopyOfVector v2){
	 ...
	 * @return
	 */
	public double includedAngle(CopyOfVector v1, CopyOfVector v2){
		return includedAngleRadian(v1,v2) * (180/Math.PI);
	}
	
	private double includedAngleRadian(CopyOfVector v1, CopyOfVector v2){
		return Math.acos(CopyOfVector.dotProduct(v1, v2)/(v1.magnitude()*v2.magnitude()));
	}
	 ...
	 */
	public CopyOfVector unitVector(){
		return new CopyOfVector(this.x/this.magnitude(),this.y/this.magnitude(), this.z/this.magnitude());
	}
...
//		
		return new CopyOfVector(v1.y*v2.z-v1.z*v2.y, -v1.x * v2.z + v1.z * v2.x, v1.x * v2.y - v1.y * v2.x);
